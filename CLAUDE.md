...
```bash
./install_packages.sh    # Install software (Homebrew on mac, pacman/yay on Arch), oh-my-zsh, powerlevel10k, herdr plugins
...
- `docs/hotkeys.md` - Cross-machine hotkey philosophy and the Omarchy ⇄ Mac chord map
